  ...
  <section className="w-full my-6">
        <div className="w-full flex items-center justify-between">
          <p className="text-2xl font-semibold capitalize
           ...
           before:bg-gradient-to-tr from-green-700 to-green-900 
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-green-600 hover:bg-green-800
        ...
        <RowContainer
          ...
          flag={true}
          data={foodItems?.filter((n) => n.category === "favors")}
        />
      </section>
